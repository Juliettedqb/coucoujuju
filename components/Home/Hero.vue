      ...
      <div class="max-w-2xl mx-auto lg:max-w-5xl">
        <div class="max-w-2xl">
          ...
          <h1 class="text-4xl font-bold tracking-tight text-zinc-100 sm:text-5xl">
            I'm Juliette. I am a human being who's learning computer science. 
          </h1>
          <p class="mt-6 text-base text-zinc-400">
            My name is Thomas, and I'm a freelance developer and designer from France, but also an Indie maker!
